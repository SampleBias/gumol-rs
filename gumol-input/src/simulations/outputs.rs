...
use gumol_sim::output::Output;
use gumol_sim::output::{TrajectoryOutput, PropertiesOutput, EnergyOutput};
use gumol_sim::output::{ForcesOutput, CellOutput, CustomOutput, StressOutput};
