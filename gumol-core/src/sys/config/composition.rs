...
impl Composition {
    ...
    ///
    /// ```
    /// # use gumol_core::sys::Composition;
    ...
    ///
    /// ```
    /// # use gumol_core::sys::{Composition, ParticleKind};
    ...
    ///
    /// ```
    /// # use gumol_core::sys::{Composition, Molecule, Particle};
    ...
    ///
    /// ```
    /// # use gumol_core::sys::{Composition, Particle, Molecule};
    /// let mut composition = Composition::new();
    /// let he = Molecule::new(Particle::new("He")).hash();
    /// let ar = Molecule::new(Particle::new("Ar")).hash();
    ///
