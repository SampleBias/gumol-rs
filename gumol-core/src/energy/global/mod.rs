...
///
/// ```
/// use gumol_core::energy::{GlobalPotential, GlobalCache};
/// use gumol_core::types::{Vector3D, Matrix3};
/// use gumol_core::sys::{System, Configuration, Particle, Molecule, UnitCell};
///
...
/// use gumol_core::energy::{GlobalPotential, GlobalCache};
/// use gumol_core::types::{Vector3D, Matrix3};
/// use gumol_core::sys::Configuration;
///
/// /// Shift the energy of all the particles by a given delta.
/// #[derive(Clone)]
/// struct ShiftAll {
