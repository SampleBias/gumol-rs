...
//!
//! ```
//! use gumol_core::energy::{Potential, PairPotential, DihedralPotential};
//!
//! #[derive(Clone)]
//! struct OnePotential;
//!
...
///
/// ```
/// use gumol_core::energy::{Potential, PairPotential};
///
/// // A no-op potential
/// #[derive(Clone)]
/// struct Null;
...
///
/// ```
/// use gumol_core::energy::{Potential, BondPotential};
///
/// // A no-op potential
/// #[derive(Clone)]
/// struct Null;
...
///
/// ```
/// use gumol_core::energy::{Potential, AnglePotential};
///
/// // A no-op potential
/// #[derive(Clone)]
/// struct Null;
...
///
/// ```
/// use gumol_core::energy::{Potential, DihedralPotential};
///
/// // A no-op potential
/// #[derive(Clone)]
/// struct Null;
